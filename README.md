...
- [Predicting-Model-on-Vehicle](#predicting-model-on-vehicle)
...
- [Cross Validation](#cross-validation)
  ...
  - [OverSampling](#due-to-the-imbalance-of-the-data-we-oversampling-the-data)
- [Desicion Tree and K-Nearest Neighbors](#desicion-tree-and-k-nearest-neighbors)
  - [Desicion Tree](#desicion-tree)
  - [K-Nearest Neighbors](#k-nearest-neighbors)
  - [Comparision of Desicion and K-Nearest Neighbors](#comparision-of-desicion-and-k-nearest-neighbors)
- [Ref:](#ref)
...
```
## Due to the imbalance of the data, we oversampling the data
please see the detail and code [here](https://github.com/JieniChen/resampling-data)
